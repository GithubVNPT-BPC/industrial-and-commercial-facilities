...
@Component({
    selector: 'app-border-trade-overview',
    templateUrl: './border-trade-overview.component.html',
    styleUrls: ['../../../special_layout.scss']
})
export class BorderTradeOverviewComponent implements OnInit {
    ...
    private readonly LINK_DEFAULT: string = "/specialized/commecial-management/border_trade/overview";
    private readonly TITLE_DEFAULT: string = "Tổng quan xuất nhập khẩu biên giới";
    private readonly TEXT_DEFAULT: string = "Tổng quan xuất nhập khẩu biên giới";
    ...
    list_object: Array<Object> = [
        { ten_cua_khau: 'Tất cả cửa khẩu', obj_id: 8 },
        { ten_cua_khau: 'Cửa khẩu Hoa Lư', obj_id: 5 },
        { ten_cua_khau: 'Cửa khẩu Hoàng Diệu', obj_id: 6 },
        { ten_cua_khau: 'Cửa khẩu Lộc Thịnh', obj_id: 7 }
    ]
    years: Array<number> = [];
