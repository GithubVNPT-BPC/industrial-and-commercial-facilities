...
export class MarketCommecialManagementComponent extends BaseComponent {
  ...
  marketTypeList = [
    { id_tinh_chat_cho: 1, tinh_chat_cho: "Hạng I"},
    { id_tinh_chat_cho: 2, tinh_chat_cho: "Hạng II"},
    { id_tinh_chat_cho: 3, tinh_chat_cho: "Hạng III"},
    { id_tinh_chat_cho: 4, tinh_chat_cho: "Làm tạm"},
    { id_tinh_chat_cho: 5, tinh_chat_cho: "Chưa có"}, 
  ];
  landUseTypeList = [
  ...
  marketPropTypeList = [
    {id_hang_cho: 1, loai_hang_cho: "Kiên cố"},
    {id_hang_cho: 1, loai_hang_cho: "Bán kiên cố"},
    {id_hang_cho: 1, loai_hang_cho: "Chưa có nhu cầu xây dựng"},
    {id_hang_cho: 1, loai_hang_cho: "Đề xuất xây dựng"},
    {id_hang_cho: 1, loai_hang_cho: "Đã có kế hoạch xây dựng"},
    {id_hang_cho: 1, loai_hang_cho: "Khác"},
    {id_hang_cho: 1, loai_hang_cho: "Chợ tạm"},
  ]

  displayedColumns = ['select', 'index'];
