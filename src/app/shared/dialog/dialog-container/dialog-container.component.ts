...
export class DialogContainerComponent implements OnInit, AfterViewInit  {
  ...
  componentRef: ComponentRef<DialogContainerComponent>;
  ...
  constructor(
    ...
    public dialog: MatDialogRef<DialogContainerComponent>,
  ...
  renderComponent() {
    ...
    const componentFactory = cfr.resolveComponentFactory(DialogContainerComponent);
