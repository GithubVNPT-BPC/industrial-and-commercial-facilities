...
@Component({
  selector: 'app-dialog-container-noCondition',
  templateUrl: './dialog-container-noCondition.component.html',
  styles: []
})
export class DialogContainerNoConditionComponent implements OnInit, AfterViewInit  {
  ...
  componentRef: ComponentRef<DialogContainerNoConditionComponent>;
  ...
  constructor(
    ...
    public dialog: MatDialogRef<DialogContainerNoConditionComponent>,
  ...
  renderComponent() {
    ...
    const componentFactory = cfr.resolveComponentFactory(DialogContainerNoConditionComponent);
